    ...
    <body>
        ...
        <form action="" method="POST">
            ...
            <select id="bat" name="batiment">
                ...
                <option value="maisonInt" disabled>Maison intelligente</option>
                <option value="batAadministration" disabled>Batiment A (administration)</option>
                <option value="batAbibli" disabled>Batiment A (bibliothèque)</option>
                <option value="batimentB">Batiment B (G.I.M. & Info)</option>
                <option value="batimentC" disabled>Batiment C (Recherche) + Amphi1 + Local Technique</option>
                <option value="batimentE" disabled>Batiment E (R&T)</option>
            </select>
