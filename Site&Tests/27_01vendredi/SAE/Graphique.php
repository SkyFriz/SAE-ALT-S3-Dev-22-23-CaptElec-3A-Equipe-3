    ...
    <body>
        ...
        <div class="graphique">
            <?php
                ...
                echo "<iframe src="."http://51.38.52.224:3000/d-solo/yzPzqDo4z/sae?orgId=1&var-Salle=".$_GET['Salle']."&var-Type=".$_COOKIE["type"]."&from=now-24h&to=now&refresh=5s&panelId=10 "."width="."900 "."height="."400 "."frameborder="."0"."></iframe>";
            ?>
